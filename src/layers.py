...
class VectorQuantizer2D(nn.Module):
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False):
        ...
        total_min_distance = torch.sum(min_distance)
        min_encoding_indices = torch.argmin(d, dim=1)
        distances = d[:, min_encoding_indices].view(z.shape)
        ...
        return z_q, loss, distances, (perplexity, min_encodings, min_encoding_indices)
